...
INVALID_BOOKING_CASES = [
    ...
    (
        "missing_lastname",
        {"firstname": "Bruce", "totalprice": 100, "depositpaid": True,
    ...
    (
        ...
        {"firstname": "Bruce", "lastname": "Wayne", "totalprice": "one_hundred",
            "depositpaid": True, "bookingdates": {"checkin": "2026-01-01", "checkout": "2026-01-02"}}
    ),
    # Case 3: Wrong depositpaid  bug
    (
        "wrong_depositpaid_type",
        {"firstname": "Bruce", "lastname": "Wayne", "totalprice": 100, "depositpaid": "Yes",
            "bookingdates": {"checkin": "2026-01-01", "checkout": "2026-01-02"}}
    ),

    (
        "wrong_bookingdates_format",
        {"firstname": "Bruce", "lastname": "Wayne", "totalprice": 100, "depositpaid": True,
            "bookingdates": {"checkin": "not-a-date", "checkout": "2026-01-02"}}
    ),
    # Case 4: Empty
    (
        "empty_booking",
